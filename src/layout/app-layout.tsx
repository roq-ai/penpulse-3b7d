...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['blog-owner', 'content-creator'];
  ...
  const { data, error, isLoading } = useSWR<PublisherInterface[]>(
    ...
    () => getPublishers({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Topic', path: '/topics', entity: 'topic', service: AccessServiceEnum.PROJECT, icon: FiTag },
